...
namespace ConsoleApp1
{
    class Program
    {
        ...
        private static void KeyGenerationAndEncryption()
        {
            ...
            var passphraseCode = new BitcoinPassphraseCode("my secret", Network.TestNet, null);// we give this passphraseCode to 3rd party
            ...
            Console.WriteLine("child11.PrivateKey == sameChild11.PrivateKey : " + (child11.PrivateKey == sameChild11.PrivateKey));
